...
pub const UART_ADDR: usize = 0x0_1FE2_0000 + 0x8000_0000_0000_0000;
...
/// hart start address
pub const HART_START_ADDR: usize = 0x9000_0000_0020_0000;
...
pub const VIRTIO0: usize = 0 + KERNEL_ADDR_OFFSET;
