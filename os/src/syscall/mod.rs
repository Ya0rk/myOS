...
pub async fn syscall(syscall_id: usize, args: [usize; 6]) -> SysResult<usize> {
    ...
    match syscode {
        ...
        SysCode::SYSCALL_PSELECT => sys_pselect(args[0] as usize, args[1] as usize, args[2] as usize, args[3] as usize, args[4] as usize, args[5] as usize).await,
        SysCode::SYSCALL_GET_MEMPOLICY => sys_get_mempolicy(),
        SysCode::SYSCALL_GETITIMER => sys_getitimer(args[0] as usize, args[1] as usize),
        SysCode::SYSCALL_SETITIMER => sys_setitimer(args[0] as usize, args[1] as usize, args[2] as usize).await,
        ...
        SysCode::SYSCALL_RENAMEAT2 => sys_renameat2(args[0] as isize, args[1] as usize, args[2] as isize, args[3] as usize, args[4] as u32),
        ...
        SysCode::SYSCALL_MKDIRAT => sys_mkdirat(args[0] as isize, args[1] as usize, args[2] as usize),
        SysCode::SYSCALL_UNLINKAT => sys_unlinkat(args[0] as isize, args[1] as usize, args[2] as u32),
        SysCode::SYSCALL_LINKAT => sys_linkat(args[0] as isize, args[1] as usize, args[2] as isize, args[3] as usize, args[4] as u32),
        SysCode::SYSCALL_UMOUNT2 => sys_umount2(args[0] as usize, args[1] as u32),
        SysCode::SYSCALL_MOUNT => sys_mount(args[0] as usize, args[1] as usize, args[2] as usize, args[3] as u32, args[4] as usize),
        SysCode::SYSCALL_CHDIR => sys_chdir(args[0] as usize),
        SysCode::SYSCALL_OPENAT => sys_openat(args[0] as isize, args[1] as usize, args[2] as u32, args[3] as usize),
        ...
        SysCode::SYS_STATX => sys_statx(args[0] as i32, args[1] as usize, args[2] as u32, args[3] as u32, args[4] as usize),
        ...
        SysCode::SYSCALL_FSTATAT => sys_fstatat(args[0] as isize, args[1] as usize, args[2] as usize, args[3] as u32),
        ...
        _ => SysResult::Err(crate::utils::Errno::EBADCALL),
    }
}
