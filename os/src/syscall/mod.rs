...
pub async fn syscall(syscall_id: usize, args: [usize; 6]) -> SysResult<usize> {
    ...
    match syscode {
        ...
        SysCode::SYSCALL_OPENAT => sys_openat(args[0] as isize, args[1] as *const u8, args[2] as u32, args[3] as usize).await,
        ...
        SysCode::SYSCALL_READ => sys_read(args[0], args[1] as *const u8, args[2]).await,
