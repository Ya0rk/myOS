...
impl Ext4File {
    ...
    ///
    /// 返回一个新的 `Ext4File` 实例
    pub fn new(path: &str, types: Ext4InodeType) -> Self {
        Self {
            file_desc: ext4_file {
    ...
    ///
    /// 返回 inode 的类型
    pub fn get_type(&self) -> Ext4InodeType {
    ...
    pub fn check_inode_exist(&mut self, path: &str, types: Ext4InodeType) -> bool {
        let c_path = CString::new(path).expect("CString::new failed");
        let c_path = c_path.into_raw();
    ...
    */
    ...
    ///
    /// 返回 inode 的类型
    pub fn file_type_get(&mut self) -> Ext4InodeType {
        ...
        let itypes = match types {
            0x1000 => Ext4InodeType::EXT4_INODE_MODE_FIFO,
            0x2000 => Ext4InodeType::EXT4_INODE_MODE_CHARDEV,
            0x4000 => Ext4InodeType::EXT4_INODE_MODE_DIRECTORY,
            0x6000 => Ext4InodeType::EXT4_INODE_MODE_BLOCKDEV,
            0x8000 => Ext4InodeType::EXT4_INODE_MODE_FILE,
            0xA000 => Ext4InodeType::EXT4_INODE_MODE_SOFTLINK,
            0xC000 => Ext4InodeType::EXT4_INODE_MODE_SOCKET,
            0xF000 => Ext4InodeType::EXT4_INODE_MODE_TYPE_MASK,
            _ => {
                warn!("Unknown inode mode type {:x}", types);
                Ext4InodeType::EXT4_INODE_MODE_FILE
            }
        };
    ...
    pub fn read_dir_from(&self, _off: u64) -> Result<Vec<OsDirent>, i32> {
        if self.this_type != Ext4InodeType::EXT4_DE_DIR {
            return Err(22);
        }
        let c_path = self.file_path.clone();
        let c_path = c_path.into_raw();
...
impl From<usize> for Ext4InodeType {
    ...
    fn from(num: usize) -> Ext4InodeType {
        match num {
            0 => Ext4InodeType::EXT4_DE_UNKNOWN,
            1 => Ext4InodeType::EXT4_DE_REG_FILE,
            2 => Ext4InodeType::EXT4_DE_DIR,
            3 => Ext4InodeType::EXT4_DE_CHRDEV,
            4 => Ext4InodeType::EXT4_DE_BLKDEV,
            5 => Ext4InodeType::EXT4_DE_FIFO,
            6 => Ext4InodeType::EXT4_DE_SOCK,
            7 => Ext4InodeType::EXT4_DE_SYMLINK,
            0x1000 => Ext4InodeType::EXT4_INODE_MODE_FIFO,
            0x2000 => Ext4InodeType::EXT4_INODE_MODE_CHARDEV,
            0x4000 => Ext4InodeType::EXT4_INODE_MODE_DIRECTORY,
            0x6000 => Ext4InodeType::EXT4_INODE_MODE_BLOCKDEV,
