...
```,
    caption: [FrameTracker 结构体],
    label-name: "frame-tracker",
)
...
```,
    caption: [Boot 阶段高位映射代码],
    label-name: "boot-high-mapping",
)
...
```,
    caption: [地址空间管理结构体],
    label-name: "memory-space-structs",
)
